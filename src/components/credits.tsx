const credits: React.ReactNode[] = [
  ...
  <a className="credit-link" href="http://www.geoplugin.com/" target="_new">geoPlugin</a></p>,
  ...
  <p>Cloud icons created by {' '}<a className="credit-link" href="https://www.flaticon.com/free-icons/cloud" title="cloud icons">iconixar - Flaticon</a></p>
]
